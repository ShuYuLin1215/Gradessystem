...
public class enrollstdAdapter extends BaseAdapter
    {
        Context context;
        private LayoutInflater mLayInf;
        List<Map<String, Object>> mItemList;
        public enrollstdAdapter(Context context, List<Map<String, Object>> itemList)
        {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            View v = mLayInf.inflate(R.layout.enrollstd_item, parent, false);
